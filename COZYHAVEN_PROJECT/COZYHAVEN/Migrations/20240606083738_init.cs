    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "1234567890", new DateTime(1990, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "john@example.com", "John", new byte[0], "Doe", new byte[0], new DateTime(2024, 6, 6, 14, 7, 37, 675, DateTimeKind.Local).AddTicks(4226), 2, "john_doe" },
                    { 2, "9876543210", new DateTime(1985, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "jane@example.com", "Jane", new byte[0], "Smith", new byte[0], new DateTime(2024, 6, 6, 14, 7, 37, 675, DateTimeKind.Local).AddTicks(4230), 1, "jane_smith" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Great experience!", new DateTime(2024, 6, 6, 14, 7, 37, 675, DateTimeKind.Local).AddTicks(4663), 1, 4.5f, 1 },
                    { 2, "Excellent service!", new DateTime(2024, 6, 6, 14, 7, 37, 675, DateTimeKind.Local).AddTicks(4666), 2, 5f, 2 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 2, new DateTime(2024, 6, 6, 14, 7, 37, 675, DateTimeKind.Local).AddTicks(4739), new DateTime(2024, 6, 6, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2024, 6, 8, 0, 0, 0, 0, DateTimeKind.Local), 0, 1, 2, 250f, 1 });

            migrationBuilder.InsertData(
                table: "Payments",
                columns: new[] { "PaymentId", "Amount", "PaymentDate", "PaymentMethod", "ReservationId", "Status" },
                values: new object[] { 1, 250f, new DateTime(2024, 6, 6, 14, 7, 37, 675, DateTimeKind.Local).AddTicks(4767), "Credit Card", 1, 1 });
